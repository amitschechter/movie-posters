...
from pytorch_load_data_topFiveGenres import load_data
...
#                   7.52e-05, #western
                  ...
                  0.0959, #Horror
                  0.1143, #Romance
                  0.0971, #Science fiction
#                   0.1628, #Fantasy
                  0.2196] #Family
#                   0.015177000000000001, #Documentary
#                   0.051547, #History
#                   0.026259, #music
#                   0.071176, #mystery
#                   0.010339000000000001, #TV movie
#                   0.026667999999999997] #war
...
#     lr_record_file= open("Results/multi_label_TL/test%s.txt" %(learn_rt),"w+")
    lr_record_file= open("Results/multi_label_TL_10genres/multi_resnet18_ADAM_LR_%s.txt"%(learn_rt),"w+")
    ...
    axes[2].legend()
    fig.savefig("Results/multi_label_TL_10genres/multi_resnet18_plots_ADAM_LR_%s.eps"%(learn_rt))    
    fig.savefig("Results/multi_label_TL_10genres/multi_resnet18_plots_ADAM_LR_%s.jpg"%(learn_rt))   
    
    with open("Results/multi_label_TL_10genres/PickleFile_%s.pickle"%(learn_rt), 'wb') as file:
