...
class MOVIES(Dataset):
    ...
    def __init__(self, images_folder, labels_doc, transform=None, preload=False, train=True, genreIdx=7):
        ...
        # 'Action'[0], 'Thriller'[1], 'Adventure'[2], 'Comedy'[5], 'Crime'[6], 
        # 'Drama'[7], 'Horror'[8], 'Romance'[9], 'Science Fiction'[10], 'Family'[12], 
        
        labels = all_filenames[all_filenames['Action', 'Thriller', 'Adventure', 'Comedy', 'Crime', 
                                             'Drama', 'Horror', 'Romance', 'Science Fiction', 'Family']] 
