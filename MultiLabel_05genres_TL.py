...
#     lr_record_file= open("Results/multi_label_TL/test%s.txt" %(learn_rt),"w+")
    lr_record_file= open("Results/multi_label_TL_5genres/multi_resnet18_ADAM_LR_%s.txt"%(learn_rt),"w+")
    ...
    axes[2].legend()
    fig.savefig("Results/multi_label_TL_5genres/multi_resnet18_plots_ADAM_LR_%s.eps"%(learn_rt))    
    fig.savefig("Results/multi_label_TL_5genres/multi_resnet18_plots_ADAM_LR_%s.jpg"%(learn_rt))   
    
    with open("Results/multi_label_TL_5genres/PickleFile_%s.pickle"%(learn_rt), 'wb') as file:
